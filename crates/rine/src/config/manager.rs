...
use super::dirs::{app_hash, rine_root};
...
mod tests {
    ...
    fn save_and_reload() {
        ...
        cfg.windows_version = super::super::schema::WindowsVersion::Win7;
        ...
        assert_eq!(
            loaded.windows_version,
            super::super::schema::WindowsVersion::Win7
        );
