...
///
/// # Notes
/// This function is currently not implemented and will return `BOOL::FALSE` for all formats.
#[rine_dlls::stubbed]
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub extern "stdcall" fn IsClipboardFormatAvailable(_format: u32) -> BOOL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub extern "stdcall" fn OpenClipboard(_hwnd: Hwnd) -> BOOL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub extern "stdcall" fn CloseClipboard() -> BOOL {
