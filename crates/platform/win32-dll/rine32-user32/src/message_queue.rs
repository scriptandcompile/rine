...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn get_message_a(
    msg: *mut Msg,
    hwnd: usize,
    msg_filter_min: u32,
    msg_filter_max: u32,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn get_message_w(
    msg: *mut Msg,
    hwnd: usize,
    msg_filter_min: u32,
    msg_filter_max: u32,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn peek_message_a(
    msg: *mut Msg,
    hwnd: usize,
    msg_filter_min: u32,
    msg_filter_max: u32,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn peek_message_w(
    msg: *mut Msg,
    hwnd: usize,
    msg_filter_min: u32,
    msg_filter_max: u32,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn translate_message(msg: *const Msg) -> i32 {
    unsafe { common::translate_message(msg) }
}

#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn dispatch_message_a(msg: *const Msg) -> isize {
    unsafe {
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn dispatch_message_w(msg: *const Msg) -> isize {
    dispatch_message_a(msg)
}

#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn post_quit_message(exit_code: i32) {
    common::post_quit_message(exit_code);
}

#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn post_message_a(
    hwnd: usize,
    msg: u32,
    w_param: usize,
    l_param: isize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn post_message_w(
    hwnd: usize,
    msg: u32,
    w_param: usize,
    l_param: isize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn send_message_a(
    hwnd: usize,
    msg: u32,
    w_param: usize,
    l_param: isize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn send_message_w(
    hwnd: usize,
    msg: u32,
    w_param: usize,
    l_param: isize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn def_window_proc_a(
    hwnd: usize,
    msg: u32,
    w_param: usize,
    l_param: isize,
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn def_window_proc_w(
    hwnd: usize,
    msg: u32,
    w_param: usize,
    l_param: isize,
