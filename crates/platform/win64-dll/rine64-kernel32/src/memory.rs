...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn LocalAlloc(_uflags: u32, size: usize) -> HLOCAL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn GlobalAlloc(_uflags: u32, size: usize) -> HGLOBAL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn GlobalFree(hmem: HGLOBAL) -> HGLOBAL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn GlobalLock(hmem: HGLOBAL) -> *mut u8 {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn GlobalUnlock(hmem: HGLOBAL) -> BOOL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn LocalReAlloc(_hmem: HLOCAL, _new_size: usize, _flags: u32) -> HLOCAL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn GlobalReAlloc(
    _hmem: HGLOBAL,
    _new_size: usize,
    _flags: u32,
) -> HGLOBAL {
