...
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn LoadCursorA(_hinstance: u32, _name: LPCSTR) -> u32 {
    unsafe {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn LoadCursorW(_hinstance: u32, _name: LPCWSTR) -> u32 {
    unsafe {
        let Some(cursor_name) = _name.read_string() else {
            warn!(
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "win64" fn GetCursorPos(_lppt: *mut Point) -> BOOL {
