...
#[unsafe(no_mangle)]
pub extern "win64" fn IsClipboardFormatAvailable(_format: u32) -> BOOL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub extern "win64" fn OpenClipboard(_hwnd: Hwnd) -> BOOL {
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub extern "win64" fn CloseClipboard() -> BOOL {
